    ...
    public static class Entry
    {
        ...
        public static int Main(IntPtr args, int argc)
        {
            try
            {
                ...
                Logger.Log("  Angene (Managed)", LoggingTarget.MainConstructor);
        ...
        private static void RunGame()
        {
            try
            {
                ...
                try
                {
                    ...
                    config.Title = "Angene | Editor";
                    config.Transparency = Win32.WindowTransparency.SemiTransparent;
                    config.Width = 430; config.Height = 560;
                ...
                AngeneEditor.Scenes.Init? scene = null;
                try
                {
                    scene = new AngeneEditor.Scenes.Init(window);
