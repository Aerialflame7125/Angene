...
namespace Angene.Input
{
    ...
    public partial struct Keys // i dunno what people will and wont use, so this is yoinked from an xlib header file
    {
        ...
        public enum IKeyCodeMultiKeyX : uint
        {
            Multi_key                     = 0xff20,
            Codeinput                     = 0xff37,
        ...
        public enum IKeyCodeCursorControlX : uint
        {
            Home                          = 0xff50,
            Left                          = 0xff51,
            Up                            = 0xff52,
        ...
        public enum IKeyCodeMiscX : uint
        {
            Select                        = 0xff60,
            Print                         = 0xff61,
            Execute                       = 0xff62,
        ...
        public enum IKeyCodeNumPadX : uint
        {
            KP_Space                      = 0xff80,
            KP_Tab                        = 0xff89,
            KP_Enter                      = 0xff8d,
        ...
        public enum IKeyCodeFuncX : uint
        {
            F1                            = 0xffbe,
            F2                            = 0xffbf,
            F3                            = 0xffc0,
        ...
        public enum IKeyCodeXKBExtensionX : uint
        {
            ISO_Lock                      = 0xfe01,
        ...
        public enum IKeyCode3270X : uint
        {
        ...
        public class IKeyCodeLangX
        {
            public enum IKeyCodeJPX : uint
            {
                Kanji                         = 0xff21,
                Muhenkan                      = 0xff22,
                Henkan_Mode                   = 0xff23,
            ...
            public enum IKeyCodeLatin1X : uint
            {
                space                         = 0x0020,
                exclam                        = 0x0021,
                quotedbl                      = 0x0022,
            ...
            public enum IKeyCodeLatin2X : uint
            {
                Aogonek                       = 0x01a1,
                breve                         = 0x01a2,
                Lstroke                       = 0x01a3,
            ...
            public enum IKeyCodeLatin3X : uint
            {
                Hstroke                       = 0x02a1,
                Hcircumflex                   = 0x02a6,
                Iabovedot                     = 0x02a9,
            ...
            public enum IKeyCodeLatin4X : uint
            {
                kra                           = 0x03a2,
                kappa                         = 0x03a2,
                Rcedilla                      = 0x03a3,
            ...
            public enum IKeyCodeLatin8X : uint
            {
                Babovedot                  = 0x1001e02,
                babovedot                  = 0x1001e03,
                Dabovedot                  = 0x1001e0a,
            ...
            public enum IKeyCodeLatin9X : uint
            {
                OE                            = 0x13bc,
                oe                            = 0x13bd,
                Ydiaeresis                    = 0x13be,
            ...
            public enum IKeyCodeJPKatakanaX : uint
            {
                overline                      = 0x047e,
        ...
        public enum IKeyCodeTechnicalX : uint
        {
            leftradical                   = 0x08a1,
        ...
        public enum IKeyCodeSpecialX : uint
        {
            blank                         = 0x09df,
            soliddiamond                  = 0x09e0,
            checkerboard                  = 0x09e1,
        ...
        public enum IKeyCodePublishingX : uint
        {
            emspace                       = 0x0aa1,
            enspace                       = 0x0aa2,
            em3space                      = 0x0aa3,
        ...
        public enum IKeyCodeCurrencyX : uint
        {
            EcuSign                    = 0x10020a0,
            ColonSign                  = 0x10020a1,
