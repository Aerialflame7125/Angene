...
public class ComponentStructs
{
    ...
    public class Cameras
    {
        internal interface Camera
        {
            ...
            Matrix4x4 LookTo(Vec3 eye, Vec3 target, Vec3 up);
            Matrix4x4 Perspective(float fovRadians, float aspectRatio, float nearPlane, float farPlane);
        }

        public class VulkanCamera : Camera
        {
            public Vec3 forward { get; set; } = new (0.0f, 0.0f, -1.0f);
            public Vec3 up { get; set; } = new(0.0f, 1.0f, 0.0f);
        ...
        public class D3D11Camera : Camera
        {
            public Vec3 forward { get; set; } = new (0.0f, 0.0f, -1.0f);
            public Vec3 up { get; set; } = new(0.0f, 1.0f, 0.0f);
            public float fov { get; set; } = 45.0f;
