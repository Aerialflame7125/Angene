...
public struct WaylandInputKeys
{
	public enum DeviceProps : uint
	{
	...
	public enum KeysAndButtons : uint
	{
		KEY_RESERVED = 0,
		KEY_ESC = 1,
		KEY_1 = 2,
	...
	public enum ABS_SND_PROFILE : uint
	{
