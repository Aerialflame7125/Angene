...
public static unsafe partial class Methods
{
    static Methods()
    {
        NativeLibrary.SetDllImportResolver(typeof(VulkanResolver).Assembly, VulkanResolver.ResolveVulkanLib);
    }

    [DllImport(VulkanResolver.LibName, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
