...
public unsafe partial struct ISlangFileSystemExt
{
    ...
    public int calcCombinedPath(SlangPathType fromPathType, sbyte* path, ISlangBlob** pathOut)
    {
    ...
    public int enumeratePathContents(delegate* unmanaged[Cdecl]<SlangPathType, sbyte*, void*, void> callback, void* userData)
    {
...
public unsafe partial struct ISlangMutableFileSystem
{
    ...
    public int saveFile(nuint size)
    {
...
public unsafe partial struct ISlangWriter
{
    ...
    public int endAppendBuffer(nuint numChars)
    {
    ...
    public int write(nuint numChars)
    {
...
public unsafe partial struct TypeReflection
{
    ...
    {
        return (TypeReflection.Kind)(spReflectionType_GetKind(unchecked((SlangReflectionType*)(this))));
    }
    ...
    {
        return (TypeReflection.ScalarType)(spReflectionType_GetScalarType(unchecked((SlangReflectionType*)(this))));
    }
...
public unsafe partial struct TypeLayoutReflection
{
    ...
    public TypeReflection.Kind getKind()
    {
        return (TypeReflection.Kind)(spReflectionTypeLayout_getKind(unchecked((SlangReflectionTypeLayout*)(this))));
    }
...
public unsafe partial struct ShaderReflection
{
    ...
    public readonly sbyte* getHashedString(nuint* outCount)
    {
...
public unsafe partial struct DeclReflection
{
    ...
    {
        return (DeclReflection.Kind)(spReflectionDecl_getKind(unchecked((SlangReflectionDecl*)(this))));
    }
...
public unsafe partial struct IGlobalSession
{
    ...
    public void addBuiltins(sbyte* sourceString)
    {
    ...
    public int loadCoreModule(nuint coreModuleSizeInBytes)
    {
    ...
    public int parseCommandLineArguments(int argc, SessionDesc* outSessionDesc, ISlangUnknown** outAuxAllocation)
    {
    ...
    public int compileBuiltinModule(uint flags)
    {
    ...
    public int loadBuiltinModule(nuint sizeInBytes)
    {
...
public unsafe partial struct ISession
{
    ...
    public IModule* loadModule(ISlangBlob** outDiagnostics = null)
    {
    ...
    public IModule* loadModuleFromSource(ISlangBlob** outDiagnostics = null)
    {
    ...
    public int createCompositeComponentType(long componentTypeCount, IComponentType** outCompositeComponentType, ISlangBlob** outDiagnostics = null)
    {
    ...
    public TypeReflection* specializeType(long specializationArgCount, ISlangBlob** outDiagnostics = null)
    {
    ...
    public TypeLayoutReflection* getTypeLayout(LayoutRules rules = Default, ISlangBlob** outDiagnostics = null)
    {
    ...
    public TypeReflection* getContainerType(ContainerType containerType, ISlangBlob** outDiagnostics = null)
    {
    ...
    public int getTypeConformanceWitnessMangledName(TypeReflection* interfaceType, ISlangBlob** outNameBlob)
    {
    ...
    public int getTypeConformanceWitnessSequentialID(uint* outId)
    {
    ...
    public int createTypeConformanceComponentType(long conformanceIdOverride, ISlangBlob** outDiagnostics)
    {
    ...
    public IModule* loadModuleFromIRBlob(ISlangBlob** outDiagnostics = null)
    {
    ...
    public bool isBinaryModuleUpToDate(ISlangBlob* binaryModuleBlob)
    {
    ...
    public IModule* loadModuleFromSourceString(ISlangBlob** outDiagnostics = null)
    {
    ...
    public int getDynamicObjectRTTIBytes(uint bufferSizeInBytes)
    {
    ...
    public int loadModuleInfoFromIRBlob(sbyte** outModuleName)
    {
    ...
    public int getDeclSourceLocation(SourceLocation* outLocation)
    {
...
public unsafe partial struct IMetadata
{
    ...
    public int isParameterLocationUsed(SlangParameterCategory category, bool* outUsed)
    {
...
public unsafe partial struct ICoverageTracingMetadata
{
    ...
    public int getEntryInfo(CoverageEntryInfo* outInfo)
    {
...
public unsafe partial struct ISyntheticResourceMetadata
{
    ...
    public int getResourceInfo(SyntheticResourceInfo* outInfo)
    {
    ...
    public int findResourceIndexByID(uint* outIndex)
    {
...
public unsafe partial struct ICooperativeTypesMetadata
{
    ...
    public int getCooperativeMatrixTypeByIndex(CooperativeMatrixType* outType)
    {
    ...
    public int getCooperativeMatrixCombinationByIndex(CooperativeMatrixCombination* outCombination)
    {
    ...
    public int getCooperativeVectorTypeByIndex(CooperativeVectorTypeUsageInfo* outType)
    {
    ...
    public int getCooperativeVectorCombinationByIndex(CooperativeVectorCombination* outCombination)
    {
...
public unsafe partial struct ICompileResult
{
    ...
    public int getItemData(ISlangBlob** outblob)
    {
...
public unsafe partial struct IComponentType
{
    ...
    public ShaderReflection* getLayout(ISlangBlob** outDiagnostics = null)
    {
    ...
    public int getEntryPointCode(ISlangBlob** outDiagnostics = null)
    {
    ...
    public int getResultAsFileSystem(long targetIndex, ISlangMutableFileSystem** outFileSystem)
    {
    ...
    public void getEntryPointHash(ISlangBlob** outHash)
    {
    ...
    public int specialize(long specializationArgCount, IComponentType** outSpecializedComponentType, ISlangBlob** outDiagnostics = null)
    {
    ...
    public int linkWithOptions(IComponentType** outLinkedComponentType, CompilerOptionEntry* compilerOptionEntries, ISlangBlob** outDiagnostics = null)
    {
    ...
    public int getTargetCode(ISlangBlob** outDiagnostics = null)
    {
    ...
    public int getTargetMetadata(ISlangBlob** outDiagnostics = null)
    {
    ...
    public int getEntryPointMetadata(ISlangBlob** outDiagnostics = null)
    {
...
public unsafe partial struct IComponentType2
{
    ...
    public int getTargetCompileResult(ISlangBlob** outDiagnostics = null)
    {
    ...
    public int getEntryPointCompileResult(ISlangBlob** outDiagnostics = null)
    {
...
public unsafe partial struct IModulePrecompileService_Experimental
{
    ...
    public int getPrecompiledTargetCode(SlangCompileTarget target, ISlangBlob** outDiagnostics = null)
    {
    ...
    public int getModuleDependency(ISlangBlob** outDiagnostics = null)
    {
...
public unsafe partial struct IByteCodeRunner
{
    ...
    public int getFunctionInfo(ByteCodeFuncInfo* outInfo)
    {
    ...
    public int registerExtCall(delegate* unmanaged[Cdecl]<IByteCodeRunner*, VMExecInstHeader*, void*, void> functionPtr)
    {
    ...
    public int setPrintCallback(delegate* unmanaged[Cdecl]<sbyte*, void*, void> callback, void* userData)
    {
